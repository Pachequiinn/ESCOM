...
public class Checksum {
   ...
   * @param tam The length
   * @return The checksum
   */
  public final static long calculateChecksum(byte[] buf,int tam) {
    int length = tam;
    int i = 0;
  ...
  public final void guardavalor(byte [] bufO,int i){
      byte buf[]=new byte[i];
      for (int ii=0;ii<i;i++)
        buf[ii]=bufO[ii];
  ...
  public final void main(String[] args){
      ...
      long resultado = Checksum.calculateChecksum(buf,20);
      System.out.printf("Valor del check: %02X\n",resultado);
  }//main
